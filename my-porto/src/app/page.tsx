  ...
  return (
    <>
      ...
      <div className="p-20 bg-black">
        <h1 className="text-2xl md:text-4xl xl:text-5xl text-red-700">Hello! I'm Frisqia Fatmalaningsih</h1>
        ...
        <Link href="https://docs.google.com/document/d/1nEDnag8t90e_RDDduG1zx_XXOUD-pLVCeEp7bp-xDbc/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
          <button className="mt-4 p-2 bg-red-500 text-white rounded hover:bg-red-700">
            Check My Cv
          </button>
        </Link>
      </div>

      <div className="carousel flex justify-center items-center mt-10">
        <div className="carousel-item relative w-[500px] h-[500px] overflow-hidden">
          <Image
            ...
            layout="fill"
            objectFit="cover"
            className="rounded-lg cursor-pointer hover:scale-110 transition-transform duration-300"
      ...
      <div className="p-20">
        ...
        <div className="flex gap-2">
          <Link href="http://linkedin.com/in/frisqia-fatmalaningsih" target="_blank" rel="noopener noreferrer">
            <button className="mt-4 p-2 bg-blue-500 text-white rounded hover:bg-blue-700 flex items-center">
