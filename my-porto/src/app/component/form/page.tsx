...
export default function Form() {
  ...
  return (
    <div className="p-10 md:p-15 lg:p-20 bg-gradient-to-b from-black via-pink-500 to-black shadow-lg">
      <h1 className="text-white text-2xl md:text-3xl lg:text-4xl font-lilita mb-4 text-center">
        Any Question?
      </h1>
      <div className="flex flex-col md:flex-row">
        <div className="flex-1 mb-6 md:mr-4">
          <p className="text-xs md:text-sm lg:text-base text-white">
            I'm glad you've visited my personal portfolio website! If you have
            any questions, suggestions, or would like to collaborate, please
            feel free to contact me through this form. I will endeavor to reply
            to your message as soon as possible.
          </p>
          {/* MixPhoto hanya ditampilkan di layar besar */}
          <div className="hidden md:block mt-4 text-slate-200 font-bold text-5xl">
            {/* <MixPhoto /> */}
            <h2>FRISQIA FATMALANINGSIH</h2>
            <p>ABOUT PROJECT BLOG CONTACT</p>
            <p>LET'S COLABORATION! </p>
        ...
        <form onSubmit={formik.handleSubmit} className="flex-1 space-y-4">
          ...
          <button
            ...
            transition-all duration-300 bg-gradient-to-b from-black from-pink-500 via-pink-500 to-black hover:from-pink-500 hover:via-black hover:to-pink-500"
          >
            Submit
          </button>
        </form>
